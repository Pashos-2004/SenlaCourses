...
//    public static final String DATA_1 = "data1"; // С этими данными тест проходит
    public static final String DATA_1 = "data1,data1\ndata1"; // Надо сделать, чтобы проходил с этими данными. Правки только в CsvService.
    ...
    public void test1() throws IOException {
        ...
        try {
            ...
            assertEquals(DATA_1, row.get(HEADER_1));
